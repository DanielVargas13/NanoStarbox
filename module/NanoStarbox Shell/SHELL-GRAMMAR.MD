...
The context interface is an interface which derives from main context,
so to each child, there is no noticeable difference as to which type
of context the command is being executed within.
<br><br>
```
