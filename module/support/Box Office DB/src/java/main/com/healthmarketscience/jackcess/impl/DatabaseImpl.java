...
public class DatabaseImpl implements Database, DateTimeContext
{
   ...
   * property {@value Database#ALLOW_AUTONUM_INSERT_PROPERTY}.
   * @usage _advanced_method_
   */
   ...
   * {@code false}, but can be overridden using the system
   * property {@value Database#ENABLE_EXPRESSION_EVALUATION_PROPERTY}.
   * @usage _advanced_method_
   */
   ...
   * property {@value Database#DATE_TIME_TYPE_PROPERTY}.
   * @usage _advanced_method_
   */
