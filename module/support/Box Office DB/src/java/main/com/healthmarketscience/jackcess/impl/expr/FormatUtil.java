...
public class FormatUtil
{
    ...
    implements DateFormatBuilder
  {
    ...
    public Set<Entry<Long,String>> entrySet() {
      return new AbstractSet<Entry<Long,String>>() {
        @Override
        public int size() {
          return 2;
        }
        ...
        public Iterator<Entry<Long,String>> iterator() {
          return Arrays.<Entry<Long,String>>asList(
              new SimpleImmutableEntry<Long,String>(0L, _am),
              new SimpleImmutableEntry<Long,String>(1L, _pm))
            .iterator();
        }
      };
    }
