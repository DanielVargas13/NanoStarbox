 ...
 * @since 11.01.2016
 */
abstract class DexClassLoader extends ClassLoader implements GeneratedClassLoader {
     ...
     */
    public DexClassLoader(ClassLoader parent) {
        super(parent);
    }
    ...
    protected abstract Class<?> loadClass(@NotNull Dex dex, @NotNull String name) throws ClassNotFoundException;
