...
public class Parameters {
  ...
  public boolean parseNextParameter(ParameterParserState state, ParameterData result) {
    ...
    boolean shortDash = (!longDash) && result.source.charAt(0) == '-';
  ...
  public static class ParameterData {
    ...
    public void printTrace(PrintStream pw) {
      ...
      if (type == ParameterType.PRMTR_TYPE_LONG || type == ParameterType.PRMTR_TYPE_PROPERTY)
        pw.print("\tlongParameter: " + longParameter);
